...
(CHOOSING_ROLE, CHOOSING_CATEGORY, SENDING_RECEIPT, GET_NAME, GET_AMOUNT, GET_PLACE, \
 GET_DATE, MANAGER_LOGIN, MANAGER_OPTIONS, CHOOSE_COLUMNS ,GET_REPORT_PERIOD, ADD_CATEGORY, \
 REMOVE_CATEGORY, ADD_REPORT_PERIOD) = range(14)
